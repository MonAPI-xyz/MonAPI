...
class TeamManagementTests(APITestCase):
  ...
  def test_when_authenticated_and_update_with_empty_team_name_then_return_bad_request(self):
    user = User.objects.create_user(username="test@test.com", email="test@test.com", password="Test1234")
    team = Team.objects.create(name='myteam')
    team_member = TeamMember.objects.create(team=team, user=user)
  ...
  def test_when_authenticated_and_update_with_not_empty_team_name_then_return_success(self):
    user = User.objects.create_user(username="test@test.com", email="test@test.com", password="Test1234")
    team = Team.objects.create(name='myteam')
    team_member = TeamMember.objects.create(team=team, user=user)
  ...
  def test_when_authenticated_and_update_with_complete_team_data_then_return_success(self):
    user = User.objects.create_user(username="test@test.com", email="test@test.com", password="Test1234")
    team = Team.objects.create(name='myteam')
    team_member = TeamMember.objects.create(team=team, user=user)
